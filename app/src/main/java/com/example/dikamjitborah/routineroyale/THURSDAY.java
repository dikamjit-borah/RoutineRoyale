...
public class THURSDAY extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView=(ListView)findViewById(R.id.th_listView);

        ArrayList<HashMap<String,String>> list = new ArrayList<HashMap<String, String>>();

        HashMap<String,String> temp=new HashMap<String, String>();
        temp.put(FIRST_COLUMN, "Principles of Management");
        temp.put(SECOND_COLUMN, "09:00 - 10:00");

        list.add(temp);

        HashMap<String,String> temp2=new HashMap<String, String>();
        temp2.put(FIRST_COLUMN, "Mathematics");
        temp2.put(SECOND_COLUMN, "10:00 - 11:00");

        list.add(temp2);

        HashMap<String,String> temp3=new HashMap<String, String>();
        temp3.put(FIRST_COLUMN, "Microprocessors");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
               // int pos=position+1;
                //Toast.makeText(THURSDAY.this, Integer.toString(pos)+" Clicked", Toast.LENGTH_SHORT).show();
            }
