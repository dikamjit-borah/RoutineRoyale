...
public class TUESDAY extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        temp5.put(FIRST_COLUMN, "Library/Mentoring");
        ...
        temp8.put(FIRST_COLUMN, "Principles of Management");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
                //int pos=position+1;
                //Toast.makeText(TUESDAY.this, Integer.toString(pos)+" Clicked", Toast.LENGTH_SHORT).show();
            }
