...
public class FRIDAY extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView=(ListView)findViewById(R.id.f_listView);
        ...
        temp3.put(FIRST_COLUMN, "Computer Graphics");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            {
               // int pos=position+1;
                //Toast.makeText(FRIDAY.this, "", Toast.LENGTH_SHORT).show();
            }
